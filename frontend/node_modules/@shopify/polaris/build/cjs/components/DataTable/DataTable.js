...
class DataTableInner extends React.PureComponent {
  constructor(...args) {
    ...
    this.defaultRenderRow = ({
      ...
      const fixedFirstColumns = this.fixedFirstColumns();
      const className = css.classNames(DataTable_module.default.TableRow, hoverable && DataTable_module.default.hoverable);
  ...
  render() {
    ...
    const className = css.classNames(DataTable_module.default.DataTable, condensed && DataTable_module.default.condensed, totals && DataTable_module.default.ShowTotals, showTotalsInFooter && DataTable_module.default.ShowTotalsInFooter, hasZebraStripingOnData && DataTable_module.default.ZebraStripingOnData, hasZebraStripingOnData && rowCountIsEven && DataTable_module.default.RowCountIsEven);
    const wrapperClassName = css.classNames(DataTable_module.default.TableWrapper, condensed && DataTable_module.default.condensed, increasedTableDensity && DataTable_module.default.IncreasedTableDensity, stickyHeader && DataTable_module.default.StickyHeaderEnabled);
    ...
    const paginationMarkup = pagination ? /*#__PURE__*/React.createElement(Pagination.Pagination, Object.assign({
      type: "table"
    }, pagination)) : null;
    ...
    const stickyHeaderMarkup = stickyHeader ? /*#__PURE__*/React.createElement(AfterInitialMount.AfterInitialMount, null, /*#__PURE__*/React.createElement("div", {
      ...
      const stickyHeaderInnerClassNames = css.classNames(DataTable_module.default.StickyHeaderInner, isSticky && DataTable_module.default['StickyHeaderInner-isSticky']);
      const stickyHeaderTableClassNames = css.classNames(DataTable_module.default.StickyHeaderTable, !isScrolledFarthestLeft && DataTable_module.default.separate);
