...
exports.buttonSchema = (0, type_validate_1.matchesObject)({
    ...
    icon: (0, type_validate_1.makeOptional)((0, type_validate_1.matchesString)()),
...
Object.defineProperty(exports, "SetCodeDiscountPayload", { enumerable: true, get: function () { return Cart_1.SetCodeDiscountPayload; } });
...
function devCreateApp(config) {
    return (0, CompatibilityClient_1.compatibilityCreateApp)(config, development_1.createApp);
}
...
(function (Action) {
    ...
    Action["SET_CODE_DISCOUNT"] = "APP::CART::SET_CODE_DISCOUNT";
    Action["REMOVE_DISCOUNT"] = "APP::CART::REMOVE_DISCOUNT";
    Action["REMOVE_ALL_DISCOUNTS"] = "APP::CART::REMOVE_ALL_DISCOUNTS";
...
function toV2Config(config) {
    ...
    var shopOriginWithAdmin = "".concat(config.shopOrigin, "/admin");
    var host = (0, base64url_1.default)(shopOriginWithAdmin);
...
function compatibilityCreateApp(config, createApp) {
    var v2Config = (0, client_1.isV1Config)(config) ? toV2Config(config) : config;
    var app = createApp(v2Config);
    if ((0, client_1.isV1Config)(config)) {
