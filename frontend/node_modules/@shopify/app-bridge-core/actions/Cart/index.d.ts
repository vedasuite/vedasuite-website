...
export declare enum Action {
    ...
    SET_CODE_DISCOUNT = "APP::CART::SET_CODE_DISCOUNT",
    REMOVE_DISCOUNT = "APP::CART::REMOVE_DISCOUNT",
    REMOVE_ALL_DISCOUNTS = "APP::CART::REMOVE_ALL_DISCOUNTS",
...
export interface SetCodeDiscountPayload {
    readonly data: DiscountCode;
    readonly id?: string;
}
export interface RemoveAllDiscountsPayload {
    readonly data: {
        disableAutomaticDiscounts: boolean;
    };
    readonly id?: string;
}
...
export declare function setCodeDiscount(payload: SetCodeDiscountPayload): any;
export declare function removeAllDiscounts(payload: RemoveAllDiscountsPayload): any;
...
export declare class Cart extends ActionSet {
    ...
    dispatch(action: Action.SET_CODE_DISCOUNT, payload: SetCodeDiscountPayload): Cart;
    dispatch(action: Action.REMOVE_ALL_DISCOUNTS, payload: RemoveAllDiscountsPayload): Cart;
