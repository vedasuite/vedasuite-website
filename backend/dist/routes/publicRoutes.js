...
exports.publicRouter.get("/legal/privacy", (_req, res) => {
    res.type("html").send(renderPage("VedaSuite AI Privacy Policy", "Privacy policy for VedaSuite AI.", `
        ...
        <div class="card">
          ...
          <h2>Contact</h2>
          <p>Privacy requests can be sent to <a href="mailto:${env_1.env.publicContact.privacyEmail}">${env_1.env.publicContact.privacyEmail}</a>.</p>
        </div>
      `));
});
exports.publicRouter.get("/legal/terms", (_req, res) => {
    res.type("html").send(renderPage("VedaSuite AI Terms of Service", "Terms of service for VedaSuite AI.", `
        ...
        <div class="card">
          ...
          <h2>Contact</h2>
          <p>Questions can be sent to <a href="mailto:${env_1.env.publicContact.legalEmail}">${env_1.env.publicContact.legalEmail}</a>.</p>
        </div>
      `));
});
exports.publicRouter.get("/support", (_req, res) => {
    res.type("html").send(renderPage("VedaSuite AI Support", "Support information for VedaSuite AI.", `
        <h1>Support</h1>
        <p>Operational support for VedaSuite AI.</p>
        <div class="card">
          <h2>Contact</h2>
          <p>Email: <a href="mailto:${env_1.env.publicContact.supportEmail}">${env_1.env.publicContact.supportEmail}</a></p>
          <p>Privacy: <a href="mailto:${env_1.env.publicContact.privacyEmail}">${env_1.env.publicContact.privacyEmail}</a></p>
          <p>Security: <a href="mailto:${env_1.env.publicContact.securityEmail}">${env_1.env.publicContact.securityEmail}</a></p>
...
exports.publicRouter.get("/launch/readiness", (_req, res) => {
    res.json({
        app: "VedaSuite AI",
        generatedAt: new Date().toISOString(),
        publicUrls: {
            support: env_1.env.publicContact.supportUrl,
            privacy: env_1.env.publicContact.privacyUrl,
